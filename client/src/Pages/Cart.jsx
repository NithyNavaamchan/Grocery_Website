...
const Cart = () => {
    ...
    const { product, currency, cartItems, removeFormCart, getCartCount, updateCartItem, navigate, getCartAmount } = useAppContext()
    ...
    const getCart = () => {
        ...
        for (const key in cartItems) {
            const products = product.find((itme) => itme._id === key)
            ...
            <div className='flex-1 max-w-4xl'>
                ...
                {cartArry.map((product, index) => (
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3">
                        ...
                        <button onClick={() => removeFormCart()} className="cursor-pointer mx-auto">
